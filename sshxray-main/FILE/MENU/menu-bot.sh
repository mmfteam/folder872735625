...
Isadmin=$(curl -sS https://raw.githubusercontent.com/sreyaeve/permission/main/access  | grep $MYIP | awk '{print $5}')
...
Exp=$(curl -sS https://raw.githubusercontent.com/sreyaeve/permission/main/access  | grep $MYIP | awk '{print $3}')
fi
