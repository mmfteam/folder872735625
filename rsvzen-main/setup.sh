...
echo ""
#wget -q https://raw.githubusercontent.com/mmfteam/folder872735625/master/sshxrayv2/main/toolsinstaller.sh;chmod +x toolsinstaller.sh;./toolsinstaller.sh
...
echo -e "${CYAN}╘════════════════════════════════════════════╛\033[0m"
sleep 0.5
wget https://raw.githubusercontent.com/mmfteam/folder872735625/master/rsvzen/main/installer/sshinstaller.sh && chmod +x sshinstaller.sh && ./sshinstaller.sh
#install backup
echo -e "${CYAN}╒════════════════════════════════════════════╕\033[0m"
echo -e " \E[0;36;44;1m            Installing Backup Set           \E[0m"
echo -e "${CYAN}╘════════════════════════════════════════════╛\033[0m"
sleep 0.5
wget https://raw.githubusercontent.com/mmfteam/folder872735625/master/rsvzen/main/installer/backupinstaller.sh && chmod +x backupinstaller.sh && ./backupinstaller.sh
#Instal Xray
echo -e "${CYAN}╒════════════════════════════════════════════╕\033[0m"
echo -e " \E[0;36;44;1m           Installing Xray Services         \E[0m"
echo -e "${CYAN}╘════════════════════════════════════════════╛\033[0m"
sleep 0.5
wget https://raw.githubusercontent.com/mmfteam/folder872735625/master/rsvzen/main/installer/xrayinstaller.sh && chmod +x xrayinstaller.sh && ./xrayinstaller.sh
wget https://raw.githubusercontent.com/mmfteam/folder872735625/master/rsvzen/main/installer/websocketinstaller.sh && chmod +x websocketinstaller.sh && ./websocketinstaller.sh
wget -q https://raw.githubusercontent.com/mmfteam/folder872735625/master/rsvzen/main/installer/toolsinstaller.sh;chmod +x toolsinstaller.sh;./toolsinstaller.sh
clear
